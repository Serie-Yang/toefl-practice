...
export default function MyMenu() {
  ...
  const sectionsByGroup = GROUPS.map((group) => ({
    title: group,
    summary: getGroupRecentAccuracy(group),
    subsections: PROGRESS_SECTIONS
      .filter((section) => section.group === group)
      .map((section) => ({
        ...section,
        accuracy: getRecentAccuracy(section.key),
      })),
  }));
    ...
    <div className="page-container">
      ...
      <section className="account-card">
        ...
        <div className="account-actions">
          <button type="button" className="btn-secondary" onClick={handleResetProgress}>
            기록 전체 삭제
          </button>
